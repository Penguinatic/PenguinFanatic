package penguinatic.penguinfanatic.materials;
...
public class PenguinArmorMaterial implements ArmorMaterial {
    ...
    public Ingredient getRepairIngredient() {
        return Ingredient.ofItems(ItemsRegistry.PENGUIN_STEEL);
    }
